    ...
    function ZoneServer(serverPort, gatewayKey, UsingMongo) {
        ...
        _this.on("login", function (err, client) {
          ...
          */
                ...
                /*data = this.sendRawData(
                  client,
                  fs_1.readFileSync(`${__dirname}/data/zone/Command.ItemDefinitions.dat`)
                );*/
          ...
          */
                ...
                client.character.factionId = self.data.factionId; // unknown 2
                ...
                _this.sendData(client, "PlayerUpdate.setCharacterLoadout", self);
            }
        });
        _this._gatewayServer.on("login", function (err, client, characterId) {
            ...
            debug("[DEBUG] Client DATAS" + client.character);
